...
# --- Input Files ---
HOUSING_CSV_PATH = "/Users/shahil/Documents/UCSB/2024-2025/Spatial/housing_classified_zillow1.csv"
IMPERVIOUS_RASTER_PATH = "/Users/shahil/Documents/UCSB/2024-2025/Spatial/Annual_NLCD_FctImp_2024_CU_C1V1.tif"
ALL_BUILDINGS_PATH = "/Users/shahil/Documents/UCSB/2024-2025/Spatial/california_building_footprints_complete.gpkg"
SCHOOLS_GDB_PATH = "/Users/shahil/Downloads/CSCD_2021.gdb"
PUBLIC_LANDS_CPAD_PATH = "/Users/shahil/Documents/UCSB/2024-2025/Spatial/cpad_2024b_release/CPAD_2024b_Units.shp"
PUBLIC_LANDS_CCED_PATH = "/Users/shahil/Documents/UCSB/2024-2025/Spatial/cced_2024b_release/CCED_2024b_Release.shp"
CENSUS_TRACTS_PATH = "/Users/shahil/Documents/UCSB/2024-2025/Spatial/tl_2024_06_tract/tl_2024_06_tract.shp"
IMPERVIOUS_SURFACE_PATH_2 = '/Users/shahil/Documents/UCSB/2024-2025/Spatial/LC24_EVT_250_filtered_flat_points_OPTIMIZED.tif'
...
OUTPUT_DIR_GROUND = "/Users/shahil/Documents/UCSB/2024-2025/Spatial/output_ground_layer"
OUTPUT_DIR_ROOFTOP = "/Users/shahil/Documents/UCSB/2024-2025/Spatial/output_rooftop_layer"
...
OUTPUT_SUMMARY_CSV = "/Users/shahil/Documents/UCSB/2024-2025/Spatial/final_summary_by_tract.csv"
...
# Step 3.1: Buffer Multifamily Points to Create Area of Interest (AOI)
print("Step 3.1: Buffering multifamily points to create AOI...")
aoi = multifamily_points.geometry.buffer(250).unary_union
print("AOI created successfully.")

# Step 3.2: Clip, Clean, and Vectorize Impervious Land from NLCD Raster
print("\nStep 3.2: Vectorizing impervious land from raster...")
geoms = []
...
non_developed_polygons = gpd.GeoDataFrame(geometry=geoms, crs=src.crs).to_crs(CRS)
print(f"Found {len(non_developed_polygons)} non-developed land patches.")
